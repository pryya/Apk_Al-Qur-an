...
class _QuranListState extends State<QuranList> {
  ...
  // HOOKS KETIKA CLASS INI DI-RENDER MAKA AKAN MENJALANKAN FUNGSI YANG DI-APINYA
  @override
  void initState() {
    ...
    Future.delayed(Duration.zero).then((_) {
      // LOAD PROVIDER YANG DITAUTKAN DENGAN QURAN DATA (BERASAL DARI QURAN_MODEL.DART)
  ...
  // ADD LISTENER DAN REMOVE LISTERNER MASING - MASING MEMANGGILA METHOD _scrollListener
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        // AGAR TIDAK MENGGANGGUN PENGGUNA
        child: firstLoad ? Center(
          child: CircularProgressIndicator(),
          )
          // DETEKSI PERUBAHAN DATA MENGGUNAKAN CONSUMER
          // SEHINGGA WIDGET YANG DI-RENDER HANYA WIDGET YANG DIAPIT-NY
          : Consumer<QuranData>(
            ...
            builder: (ctx, data, _) => ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: data.items.length, // HITUNG JUMLAH DATA, MAKA LISTVIEW AKAN ME-RENDER SEBANYAK JUMLAH DATA
              // RENDER DATANYA KE DALAM CUSTOM WIDGET BERNAMA QuranSurah() YAG SELANJUTNYA AKAN KITA BUAT
